...
public class ItemQuizPoll implements Item {
    ...
    public ItemQuizPoll(Context context, JSONObject star, JSONObject feed, boolean bMore) {
    ...
    public ItemQuizPoll(Context context, JSONObject star, JSONObject feed, boolean bMore, boolean draft, boolean draftAdmin) {
    	this.m_context = context;
    ...
    public int getViewType() {
        return RowType.QUIZ_POLL_ITEM;
    }
 
    @Override
    public View getView(LayoutInflater inflater, View convertView) {
        if (convertView == null) {
        	convertView = (View) inflater.inflate(R.layout.list_feed_poll, null);
        }
		...
		TextView txtContest = (TextView) convertView.findViewById(R.id.txtContest);
